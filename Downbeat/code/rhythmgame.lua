...
function rhythmlevelone:update(dt)
    if Scene == 1 and initiated == 0 then
        ...
        Pocket2 = world:newCircleCollider(1160, 900, 100)

        Pocket2Zone1 = world:newCircleCollider(1160, 900, 100)
        Pocket2Zone2 = world:newCircleCollider(1160, 900, 80)
        Pocket2Zone3 = world:newCircleCollider(1160, 900, 50)
